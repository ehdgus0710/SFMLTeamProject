...
void Stage2::LoadResources()
{
	...
	TEXTURE_MANAGER.Load("Stage1TileMap", "graphics/TileMap/stage1.png");
...
void Stage2::Enter()
{
	...
	SpriteGameObject* backgroundObject = AddGameObject(new SpriteGameObject("YggdrasilbossBackground1", "YggdrasilBackground1"), LayerType::BackGround);

	backgroundObject->SetPosition({ mainCamera->GetView().getSize() * 0.5f });
	...
	tileMap->SetTileInfo("Stage1TileMap", { 32,32 }, { 32.f,32.f }, { 32,32 });
