...
void YggdrasilFSM::CreateAllState()
{
	for (int i = 0; i < (int)YggdrasilStateType::End; ++i)
	{
		...
		case YggdrasilStateType::YggdrasilSpecialAttack:
			...
			break;
		case YggdrasilStateType::YggdrasilPhaseUp:
			AddState(YggdrasilStateType::YggdrasilPhaseUp);
			break;
		case YggdrasilStateType::YggdrasilRecovery:
			AddState(YggdrasilStateType::YggdrasilRecovery);
			break;
...
BaseState<YggdrasilStateType>* YggdrasilFSM::CreateState(YggdrasilStateType type)
{
	...
	case YggdrasilStateType::YggdrasilSpecialAttack:
		...
		break;
	case YggdrasilStateType::YggdrasilPhaseUp:
		state = new YggdrasilPhaseUpState(this);
		break;
	case YggdrasilStateType::YggdrasilRecovery:
		state = new YggdrasilRecoveryState(this);
		break;
	case YggdrasilStateType::Dead:
